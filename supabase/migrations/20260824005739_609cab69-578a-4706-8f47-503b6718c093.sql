...
DROP POLICY IF EXISTS "Authenticated admins can read requests" ON public.inscriptions;
DROP POLICY IF EXISTS "Authenticated admins can update requests" ON public.inscriptions;
